...
const addicon = (e) => {
  if(e.innerHTML.substring(0,1) === 'e'){
    console.log(e.innerHTML.substring(0,1) + '<sup contenteditable="true">x</sup>');
      $('div.input').append('<span id="iccontent" class="input otherinput">'+ e.innerHTML.substring(0,1) + '<sup contenteditable="true">2</sup></span><span id="iccontent" class="input" contenteditable="true"> </span>')
  }
      ...
      $('div.input').append('<span style="padding: 7px 0px 6px 0px!important;" id="iccontent" class="input otherinput">'+e.innerHTML.substring(0,3) + '<sub contenteditable="true">x</sub></span><span id="iccontent" class="input" contenteditable="true"> </span>')
  }
  else{
